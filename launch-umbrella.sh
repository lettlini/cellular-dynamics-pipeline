...
#SBATCH --output=/home/20235660/nextflow-logs/nextflow_%j.out       # Standard output log (%j will be replaced with the job ID)
#SBATCH --error=/home/20235660/nextflow-logs/nextflow_%j.err        # Standard error log (%j will be replaced with the job ID)
...
#SBATCH --partition=phys.default.q           # Partition to submit to (adjust if needed)

OUTPUT_DIR=/home/20235660/nextflow/nextflow-reports/${SLURM_JOB_ID}/
